...
{ 
    ...
    {
    	int givenDamage = (currentWeapon.getWeaponDamageMin() + rand.nextInt( currentWeapon.getWeaponDamageMax() + 1) + this.getStr()) + (this.getStr()*2);
    	
    	Thing.setHealth( Thing.getHealth() - givenDamage);
    	
    	String [] actions = {"crushed", "smashed", "struck"};
    	
    	int chooseAct = rand.nextInt(3);
    	
    	if(Thing.getHealth() <= 0)   
        {   
        	System.out.println( "You " + actions[chooseAct] + " the " + Thing.getName() + " and you hit: " + givenDamage );
        	System.out.println( "The " + Thing.getName() + " is dead" );
        	System.out.println( "You received " + Thing.getExpGiven() + " points of experience" );
        	if( this.getLevel() * this.getLevel() * 100 > this.getExp() + Thing.getExpGiven() )   
            {  
